...
export function ShieldIcon({ size = 28, className }: IconProps): JSX.Element {
  return (
...
export function ShieldCheckIcon({ size = 40, className }: IconProps): JSX.Element {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" className={className}>
      <path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z" />
      <path className="checkmark-path" d="M9 12l2 2 4-4" />
    </svg>
  )
}

export function FileSpreadsheetIcon({ size = 16, className }: IconProps): JSX.Element {
  return (
...
export function ExternalLinkIcon({ size = 12, className }: IconProps): JSX.Element {
  return (
...
export function ExportIcon({ size = 13, className }: IconProps): JSX.Element {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
      <path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6" />
      <polyline points="15 3 21 3 21 9" />
...
export function CopyIcon({ size = 12, className }: IconProps): JSX.Element {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
